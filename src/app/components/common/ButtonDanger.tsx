...
// app/components/ButtonDanger.tsx
"use client";
...
export default function ButtonDanger({
  onClick,
  label = "",
  imageSrc = "/images/btn_danger.png",
  ...
  return (
    ...
    >
      <img
        ...
        draggable={false}
      />
      <span className={["relative z-10", "font-azo text-stone-800 text-lg font-bold", textClassName].join(" ")}>
        {label}
      </span>
    </button>
  );
